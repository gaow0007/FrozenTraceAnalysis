...
bash exp/speed/slurm_run_auto_memory_1.sh 1 ResNet18 '1' '65' 725 & 
bash exp/speed/slurm_run_auto_memory_1.sh 1 VGG19 '1' '37' 725 & 
bash exp/speed/slurm_run_auto_memory_1.sh 1 MobileNetV2 '1' '34' 725 & 
bash exp/speed/slurm_run_auto_memory_1.sh 1 ResNet50 '1' '79' 725 & 
