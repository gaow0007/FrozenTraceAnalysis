            ...
            for placement in info_loader(): 
                if isLegal(placement): 
                    ...
                    for (batch, frozen) in arch_info[arch]: 
                        filename = '/mnt/lustre/wgao/workspace/adaptdl/benchmark/models/yolov3/speed/model_yolo_placement_{}_bs_{}_placement_{}_frozen_{}.npy'.format(placement_str, batch, placement_str, frozen)
