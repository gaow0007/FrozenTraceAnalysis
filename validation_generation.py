...
for app in [('cifar10-ResNet18', 'cifar10'), ('cifar10-VGG19', 'cifar10'), ('cifar10-ResNet50', 'cifar10'), ('cifar10-MobileNetV2', 'cifar10'), ('cifar10-GoogLeNet', 'cifar10')]: 
    ...
    target_batch_size = 128 #  256, 512, 1024, 2048,
    ...
    for batch_size in [128, 256, 512, 1024, 2048, 4096]: 
        ...
        epoch_stats_info = np.load('stats/{}/model_{}_bs_{}_frozen_False'.format(app[0].split('-')[0], app[0].split('-')[1], batch_size), allow_pickle=True).tolist() 
        log_file = os.path.join('stats/{}/{}/{}/efficiency.txt'.format(dataset, arch, num_replicas))
